...
# bazel-bin/src/ASTRID -i $root_dir/data/zhang_lepidoptera.tre -o $root_dir/results/ASTRID/Lepidoptera_Micropterigoidea_Micropterigidae_Micropterix_calthella_Mica__N.tre
